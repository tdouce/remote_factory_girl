...
that contain a database) with tools such as [FactoryGirl](https://github.com/thoughtbot/factory_girl). RemoteFactoryGirl; however, in SOA apps the FactoryGirl will not work. RemoteFactoryGirl
when used in conjunction with [RemoteFactoryGirlHome](https://github.com/tdouce/remote_factory_girl_home),
provides a mechanism to create the data you need when you need it in the *home* app
from a client app.  We all work on the backs of giants, and RemoteFactoryGirlby leverages
the efforts of [FactoryGirl](https://github.com/thoughtbot/factory_girl).
